  ...
  return (
    <SideBar>
      ...
      <SimpleTreeView sx={{border: '3px solid #EEC759', borderRadius: '15px', padding: '4rem'}}>
        <TreeItem itemId="0" label="회원관리" onClick={()=>navigate("/admin/memberList")} sx={{ marginBottom: "2rem", "& .MuiTreeItem-label": { fontSize: "1.2rem", fontWeight: 'bold' } }} />
        <TreeItem itemId="board" label="게시판 관리" sx={{ marginBottom: "2rem", "& .MuiTreeItem-label": { fontSize: "1.2rem", fontWeight: 'bold' } }}>
          <TreeItem itemId="1" label="공지사항" onClick={()=>navigate("/admin/noticeList")} sx={{"& .MuiTreeItem-label": {fontWeight: '100'}}} />
        ...
        <TreeItem itemId="shopping-mall" label="쇼핑몰 관리" sx={{ marginBottom: "2rem", "& .MuiTreeItem-label": { fontSize: "1.2rem", fontWeight: 'bold' } }}>
          <TreeItem itemId="4" label="상품 관리" onClick={()=>navigate("/admin/productlist")} sx={{"& .MuiTreeItem-label": {fontWeight: '100'}}} />
          <TreeItem itemId="5" label="매출 관리" sx={{"& .MuiTreeItem-label": {fontWeight: '100'}}}/>
          <TreeItem itemId="6" label="주문 관리" onClick={()=>navigate("/order")} sx={{"& .MuiTreeItem-label": {fontWeight: '100'}}} />
        </TreeItem>
      </SimpleTreeView>
    </SideBar>
  )
